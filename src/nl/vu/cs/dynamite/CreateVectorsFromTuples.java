...
public class CreateVectorsFromTuples {
	private static Logger log = LoggerFactory.getLogger(CreateVectorsFromTuples.class);
	...
	public static void main(String[] args) {
		...
		new CreateVectorsFromTuples().run(args);
	}
