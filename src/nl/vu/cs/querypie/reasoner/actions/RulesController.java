...
public class RulesController extends Action {
  ...
  private void applyRulesSchemaOnly(List<ActionConf> actions) {
    ...
    a.setParamStringArray(PartitionToNodes.TUPLE_FIELDS, TLong.class.getName(), TLong.class.getName(), TLong.class.getName());
  ...
  public void stopProcess(ActionContext context, ActionOutput actionOutput) throws Exception {
    ...
    if (hasDerived) {
      ...
      if (ReasoningContext.getInstance().getRuleset().getAllSchemaOnlyRules() != null) {
